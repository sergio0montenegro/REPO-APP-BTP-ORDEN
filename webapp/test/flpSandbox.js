		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte Parte Falla Orden Mantenimiento",
									"targetURL": "#nszpmorderreportapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nszpmorderreportapp-display": {
								"semanticObject": "nszpmorderreportapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.zpmorderreportapp",
									"url": sap.ui.require.toUrl("ns/zpmorderreportapp")
								}
							}
						}
					}
